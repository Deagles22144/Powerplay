...
@Autonomous (name="ForwardRightAuto", group="AutoLeft")
public class ForwardRightAuto extends QRcode {
...
//                })
        ...
        TrajectorySequence coneLoad = drive.trajectorySequenceBuilder(Preload.end())
                ...
                .splineToSplineHeading(new Pose2d(-40, 14, Math.toRadians(180)), Math.toRadians(180))
...
//                .waitSeconds(0.17)
        ...
        TrajectorySequence coneUnload = drive.trajectorySequenceBuilder(new Pose2d(-63,13, Math.toRadians(180))/*coneLoad.end()*/)
                ...
                .splineToSplineHeading(new Pose2d(-33, 17, Math.toRadians(-130)), Math.toRadians(45))
...
//                .waitSeconds(0.2)
        ...
        TrajectorySequence ParkMid  = drive.trajectorySequenceBuilder(coneUnload.end())
                .setTangent(180)
                .lineToLinearHeading(new Pose2d(-36,25  ,Math.toRadians(-90)), SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
...
//                .splineToConstantHeading(new Vector2d(-65, 35),Math.toRadians(180))
                .lineToLinearHeading(new Pose2d(-65,12,Math.toRadians(180)), SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
...
//                .splineToSplineHeading( new Pose2d(-12,25,Math.toRadians(90)),Math.toRadians(90))
                .lineToLinearHeading(new Pose2d(-10,12,Math.toRadians(-90)), SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .back(5)
                .build();
